...
const string strMessageMagic = "snakeXcoin Signed Message:\n";
...
bool CheckDiskSpace(uint64_t nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "snakeXcoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (fTestNet)
    {
        ...
        nStakeMinAge = 3 * 60; // test net min age is 3 min
    ...
    if (mapBlockIndex.empty())
    {
        ...
        const char* pszTimestamp = "SnakeXcoin going out cave 7  june 2001";
        CTransaction txNew;
        txNew.nTime = 1402143184;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        //// debug print
        assert(block.hashMerkleRoot == uint256("0x7140a940bac31af6bc3e64766b9e286c135eb1c82c8ce18a4a7a9eb621ed8567"));
        block.print();
...
unsigned char pchMessageStart[4] = { 0xd4, 0xd3, 0xd2, 0xd1 };
